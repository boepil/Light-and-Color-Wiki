...
- `Appendix/Data & Methodology.md` — `stub` (6 lines)
...
- `Light/Spectral Locus & Excitation Purity.md` — `draft` (13 lines)
- `Light/Illuminants & Correlated Color Temperature.md` — `draft` (27 lines)
...
- `Painting/Movements & Painters/Post-Impressionism.md` — `draft` (15 lines)
- `Painting/Movements & Painters/Romanticism-Turner.md` — `draft` (7 lines)
- `Painting/Movements & Painters/Vermeer-Dutch Golden Age.md` — `draft` (15 lines)
- `Painting/Pigments/Pigments.md` — `stub`
- `Painting/Pigments/Chemistry.md` — `draft` (20 lines)
- `Painting/Pigments/Natural vs. Synthetic.md` — `draft` (20 lines)
- `Painting/Pigments/High-Chroma Synthetics.md` — `draft` (22 lines)
- `Painting/Pigments/Particle Size-Tinting-Polymorphism.md` — `draft` (24 lines)
- `Painting/Pigments/Sourcing Real Spectral Data.md` — `draft` (17 lines)
...
2. Continue page-by-page per AGENTS.md workflow