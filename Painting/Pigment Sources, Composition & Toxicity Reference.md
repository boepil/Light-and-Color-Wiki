...
Toxicity tracks **chemistry, not color** — a bright red may be inert pyrrole or cumulative-poison vermilion. Modern tube paints lock pigment in a binder, so the hazards below describe raw pigment and concentrated exposure. The table summarizes by origin family (*Artists' Pigments*, *The Artist's Handbook*):
...
| | Lead White (historical) | Basic lead carbonate | **High** — cumulative neurotoxin, largely phased out |
| | Iron oxides (Venetian Red, Mars Violet) | Synthetic iron oxide | Low |
| | Nickel Titanate / Dioxine Yellow | Nickel complexes | Moderate — nickel is a sensitizer/allergen |
...
**Real hazards to flag:** the cadmiums and cobalts. Risk is much lower in tube paint than raw pigment powder — locked in binder, low skin absorption, inert film once dry. Real exposure comes from ingestion habits (licking brushes), spray application, or sanding/scraping dried paint, which recreates dust exposure (*The Artist's Handbook*, *(Source: [[raw_sources/handprint/pigmt6.md|pigmt6.html]])*). Medium (oil/water/acrylic) does not change pigment toxicity — cadmium is cadmium regardless of binder; watercolorists have slightly higher practical exposure because wet brush tips meet the lips.
...
- **Inhalation** — raw pigment grinding (making paints by hand), spray guns/airbrushes, sanding dried paint films, and heating paint with a heat gun. **Pastel dust** is the special case: even "inert" powders must not be continuously inhaled, and pastel chalks are the main inhalation risk in normal practice (*Ralph Mayer*, *(Source: [[raw_sources/handprint/pigmt6.md|pigmt6.html]])*).
- **Skin contact** — two distinct problems: **sensitizers** (copper, nickel, manganese, cobalt) that can produce a slowly developing allergic skin condition — if redness appears within a day or two, see a dermatologist and choose alternative pigments — and **solvent irritation** (turpentine causes skin and respiratory allergies) (*Ralph Mayer*, *(Source: [[raw_sources/handprint/pigmt6.md|pigmt6.html]])*).
...
| Binder/solvent | Risk |
|---|---|
| Oil (linseed, etc.) | Inert itself; oil-soaked rags are a **fire hazard** (spontaneous combustion) — dispose in sealed metal containers |
...
| Benzene (benzol), carbon tetrachloride | **Extremely dangerous — never breathe continuously** |
| Acrylic (polymer emulsion) | Low toxicity wet; off-gases VOCs while curing, sometimes ammonia — ventilate |
| Watercolor/gouache (gum arabic) | Essentially inert — the safest binder |
| Egg tempera | Inert, food-grade |
| Water-mixable oils | Remove the turpentine fire hazard and fumes from the studio |

All volatile solvents are toxic to some degree; solvents carry **TLV (Threshold Limit Value)** ratings — acetone and ethyl alcohol have high limits (relatively safe) but remain highly flammable (*Ralph Mayer*).

### Safe Practice
Common sense, not paranoia: **wash hands and fingernails** after using lead or cadmium pigments; **never moisten brushes with the mouth**; **ventilate** when working with solvents or spraying; wear **polyethylene gloves** when handling resin hardeners and accelerators; for **children**, use only non-toxic (AP) pigments — lead-based paints and arsenical cobalts are prohibited (*(Source: [[raw_sources/handprint/pigmt6.md|pigmt6.html]])*, *Ralph Mayer*). For disposal: paint residue is not a documented pollution problem — the State of California has never ruled a site polluted because of watercolor use — though heavily pigmented wastewater should not go into septic leach fields (*(Source: [[raw_sources/handprint/pigmt6.md|pigmt6.html]])*).

## Handprint Perspectives
MacEvoy's position is that pigment toxicity is overwhelmingly a **handling problem, not a materials problem**. "Used and disposed of properly, nearly all pigments used in modern watercolor paints have no toxic consequences whatsoever" — and as a category, watercolor paints are safer than house paints, soaps, oven cleaners, solvents, bleaches, fuels, new carpets, pesticides, and some foods (shellfish), "not to mention oil paint solvents and acrylic resins." His specific cautions are behavioral: never point a brush with the lips ("I just snap the wet brush over the floor"), don't shape bristles with your mouth after painting with a toxic pigment, and take skin-sensitizer reactions seriously (copper, nickel, manganese, cobalt). On cadmium he quotes the manufacturers' own technical bulletins: "The hazards of cadmium pigments have been overstated in some published accounts, but do not ignore them" (*(Source: [[raw_sources/handprint/pigmt6.md|pigmt6.html]])*).

> [!WARNING] **Contradiction Flag:** The reference table above (following the draft and *The Artist's Handbook*) rates cadmium pigments **High — carcinogen**, while both the notebook corpus (*Artists' Pigments*, *Ralph Mayer*) and handprint counter that cadmiums are *sufficiently insoluble in binder to be safe for most uses*, with real risk limited to dust, ingestion habits, and heating above 700 °C. The resolution: hazard depends on form (raw dust vs. bound paint) — the "High" rating describes the raw pigment and cumulative misuse, not the tube.

## Subtopics
- Toxicity follows chemistry, not color — family-by-family hazards
