...
MacEvoy opens his color-theory primer with the question "Is the color in a paint, or in the light, or in the mind?" — and answers that "colors exist in the mind and are dependent on the way our eye and nerves work together, but colors are also shaped by the physical behavior of light in relation to surfaces." For him the wave–particle description matters at exactly that light–surface meeting point: when a photon strikes a material surface, three separate outcomes occur that together create the three components of material color — **surface scattering** (light not absorbed, reflected in random directions, adding **whiteness**), **chromatic reflectance** (energy thrown into the material's molecules and promptly re-emitted at specific wavelengths, producing the **hue**), and **infrared reflectance** (the remainder transformed to heat — "light goes in, nothing visible comes out"). He also warns painters not to expect clean one-to-one mapping from wavelength to sensation: every single wavelength of light stimulates **at least two** of the three cones — below ~570 nm, all three — so "we never see a 'pure' response from any single cone, and we never see 'pure primaries' in our visual experience." *(Source: [[raw_sources/handprint/color18a.md|color18a.html]], [[raw_sources/handprint/intstud.md|intstud.html]])*

## Subtopics
- Wave model: coupled transverse E/M fields, parameters λ, f, amplitude, c, phase, and **c = f·λ**
- Particle model: photons, **E = hf**, **E(eV) = 1240/λ(nm)**; worked examples 700 nm → 1.77 eV, 400 nm → 3.10 eV
- Frequency ↔ hue (4.28–7.50×10¹⁴ Hz) vs. amplitude ↔ flux/intensity
- Dual nature at work: single-photon retina absorption, photoelectric effect, Snell refraction, prismatic dispersion, polarization
- SPD as the multi-wavelength description feeding colorimetry (illuminants, CIE integration)

## Cross-References
- [[The Visible Spectrum]] — the 380–780 nm band and prismatic dispersion
- [[CIE Systems]] — tristimulus integration of spectral power
