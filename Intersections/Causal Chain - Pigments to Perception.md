...
Pointer's Gamut represents the real-world boundaries of color under standard CIE Illuminant C (**Pointer**) [6]. It inherits the lopsided asymmetry of the $V(\lambda)$ sensitivity curve—extending deeply into high-chroma greens and oranges, but shrinking significantly in the reds and blue-violet regions [4, 8].
