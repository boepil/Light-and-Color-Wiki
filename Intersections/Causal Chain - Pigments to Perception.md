...
When light reflects off these surfaces, it is filtered by the human visual system. The biological sensitivity of the human eye is standardized via the **[[Color Matching Functions and the Photopic Luminosity Function|CIE color-matching functions]]** and the photopic luminosity function **$V(\lambda)$**, which peaks at **555 nm** in the green-yellow region of the spectrum [4, 9]. 
...
* **Green-Yellow Protrusion:** Because $V(\lambda)$ peaks at 555 nm, surfaces reflecting light in this region stimulate the eye's luminance channel with extreme efficiency, allowing them to appear both highly saturated and very light simultaneously [4, 9].
