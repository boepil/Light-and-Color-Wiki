...
MacEvoy's lightfastness guidance is explicit: PW6 has "a very good track record in architectural paints and coatings," and he recommends against paints containing PW4 (zinc white) — "when white mixtures are wanted in your paintings, use PW6 to make them." His palette notes regularly pair PW6 with granulating or staining colors to control value and opacity, and the material's high tinting strength means it must be used with measure in mixtures *(Source: [[raw_sources/handprint/litetest.md|litetest.html]], [[raw_sources/handprint/pigmt3.md|pigmt3.html]])*.

## Subtopics
- Rutile vs. anatase crystal forms; 1791 discovery → 1923/1939/1957 artist grades
- Industrial manufacture; Titanox A pure / Titanox B with ~70% BaSO₄
- Refractive index 2.55/2.71 — highest hiding power of any white
- Inert, lightfast, poor oil drier; occasional yellowing; whiteout and acrylics
- Replacement of lead white (PW1) and zinc white (PW4)

## Cross-References
- [[Pigments/index|Pigments]] — the section hub
- [[Pigments/Chemistry|Chemistry]] — TiO₂ crystal chemistry
- [[Pigments/Particle Size-Tinting-Polymorphism|Particle Size-Tinting-Polymorphism]] — index-gap opacity, polymorphism
- [[Pigments/Reference/PBk6 - Carbon Black|PBk6 - Carbon Black]] — its mixture partner in neutral portrayals
- [[Pigments/Reference/PB29 - Ultramarine Blue|PB29 - Ultramarine Blue]] — reduction tests with white
