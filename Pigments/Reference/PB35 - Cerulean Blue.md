...
Cerulean holds the pale-greenish "sky" slot in MacEvoy's full palette: he notes its weak tinting strength and tendency to make gray-green darks when over-mixed, steering watercolorists to use it sparingly in graduated washes, and pairing it with ultramarine for aerial perspective. His cost and permanence tables list it as a permanent but expensive blue *(Source: [[raw_sources/handprint/palette1.md|palette1.html]], [[raw_sources/handprint/pigmt3.md|pigmt3.html]])*.

## Subtopics
- CoO·nSnO₂; PB36 chromium-cobalt variant
- Ceruleum 1805/1821; Rowney ~1860
- Calcination of cobalt + tin oxides
- Opaque, weak strength, lightfast, good oil drier
- Impressionist sky color: Monet, Pissarro, Renoir

## Cross-References
- [[Pigments/index|Pigments]] — the section hub
- [[Pigments/Reference/PB28 - Cobalt Blue|PB28 - Cobalt Blue]] — the other cobalt blue
- [[Pigments/Reference/PB29 - Ultramarine Blue|PB29 - Ultramarine Blue]] — mixing partner
- [[Painting/Movements & Painters/Impressionism|Impressionism]] — the sky color
