...
**Scope:** Burnt Umber (PBr7/PBr8) — raw umber roasted: the deep, warm, reddish transparent brown of glazes and shadows.
...
Consistent with MacEvoy's earth doctrine: burnt umber is the darkest warm transparent brown, chosen over raw umber when a redder, richer dark is wanted, and bundled with ultramarine as the stock warm-black mixture. In watercolor he lists it among the granulating earths; in oil the manganese drying rule applies with full force *(Source: [[raw_sources/handprint/pigmt3.md|pigmt3.html]], [[raw_sources/handprint/palette1.md|palette1.html]])*.

## Subtopics
- Calcined raw umber; greenish-olive → reddish-brown
- PBr7/PBr8 designation; Cyprus family
- Rapid drier (manganese); crack caution
- Warm dark glazes; ultramarine warm blacks

## Cross-References
- [[Pigments/index|Pigments]] — the section hub
- [[Pigments/Reference/PBr7 - Raw Umber|PBr7 - Raw Umber]] — the unroasted grade
- [[Pigments/Reference/PB29 - Ultramarine Blue|PB29 - Ultramarine Blue]] — warm-dark mix partner
- [[Pigments/Reference/PBr7 - Burnt Sienna|PBr7 - Burnt Sienna]] — transparent-red sibling
