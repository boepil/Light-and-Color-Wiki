...
In MacEvoy's complete-palette logic, carbon black (PBk6) is not a "color" but a **neutralizing and darkening partner** — his palette lists PBk6+PB29 mixtures for deep neutrals, applied so that black tunneling is avoided by mixing rather than by tube blacks alone. His material-attributes doctrine would caution the watercolorist about the granulating, low-staining behavior of traditional lamp/bone blacks versus the high-strength furnace blacks *(Source: [[raw_sources/handprint/palette1.md|palette1.html]], [[raw_sources/handprint/pigmt3.md|pigmt3.html]])*.

## Subtopics
- Amorphous carbon; pure (lampblack, furnace) vs. impure (bone, vine) grades
- Lascaux/Altamira; Roman *atramentum*; 1864 American furnace black
- Burning oils/fats; charring bone; calcining vines
- Weak soft traditional grades vs. intense modern furnace blacks; watercolor granulation; slow oil drying
- Aboriginal four-color palette; Reinhardt's black paintings

## Cross-References
- [[Pigments/index|Pigments]] — the section hub
- [[Pigments/Reference/PW6 - Titanium White|PW6 - Titanium White]] — the mixture partner
- [[Pigments/Reference/PB29 - Ultramarine Blue|PB29 - Ultramarine Blue]] — neutral deep mixes
- [[Painting/Movements & Painters/Color Field|Color Field]] — Reinhardt's black grid
- [[Pigments/Particle Size-Tinting-Polymorphism|Particle Size-Tinting-Polymorphism]] — granulation behavior
