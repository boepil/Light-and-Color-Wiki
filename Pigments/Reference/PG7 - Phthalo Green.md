...
**Scope:** Phthalo Green (PG7) — chlorinated copper phthalocyanine, the staining powerhouse whose masstone is nearly black and whose mixtures must be managed.
...
- The 20th-century green of stain-painting and hard-edge color — a staple of the modern palette's chromatic-neutral darks (see [[Painting/Movements & Painters/Color Field|Color Field]] and the Hansa/emerald replacement note on [[Pigments/Reference/PY97 - Hansa Yellow|PY97]]).

## Handprint Perspectives

MacEvoy calls phthalo green the most staining pigment in the palette and classifies it as a force to be handled in drops, not dabs — his doctrine teaches "phthalo relationships" by planning mixtures before pigment touches paper, and pairs PG7 with dioxazine violet and quinacridone for chromatic darks. For foliage he generally steers painters to viridian's softer character instead, reserving phthalo where extreme tinting strength is wanted *(Source: [[raw_sources/handprint/pigmt3.md|pigmt3.html]], [[raw_sources/handprint/palette1.md|palette1.html]])*.

## Subtopics
- Chlorinated copper phthalocyanine; 1927–28 Scottish Dyes Ltd.
- Artist pigment ~1938; blue phase 1930s
- Extreme tinctorial strength; letting down with alumina hydrate
- Transparent, staining, stable; masstone near-black
- Alizarin "chromatic black"; black-admixture deadening and drying shifts

## Cross-References
- [[Pigments/index|Pigments]] — the section hub
- [[Pigments/Natural vs. Synthetic|Natural vs. Synthetic]] — high-chroma synthetic generation
- [[Pigments/Reference/PG18 - Viridian|PG18 - Viridian]] — the softer green
- [[Pigments/Reference/PR108 - Cadmium Red|PR108 - Cadmium Red]] — complementary pairing
- [[Painting/Movements & Painters/Color Field|Color Field]] — staining-paint use
