...
**Scope:** Raw Umber (PBr7) — the manganese-bearing earth, darkest and most neutral of the naturals, and its career as the rapid-drying low-key grounder of the palette.
...
- Cyprus grades; cave-paint use since antiquity
- Calcination → burnt umber (PBr8); greenish-olive → reddish-brown
- Manganese siccative: rapid drier, crack-risk in underpainting
- Canvas toning; umber+ultramarine warm blacks; earthy olives

## Cross-References
- [[Pigments/index|Pigments]] — the section hub
- [[Pigments/Reference/PBr7 - Burnt Sienna|PBr7 - Burnt Sienna]] — the sienna sibling
- [[Pigments/Reference/PB29 - Ultramarine Blue|PB29 - Ultramarine Blue]] — the warm-dark mix partner
- [[Pigments/Reference/PBk6 - Carbon Black|PBk6 - Carbon Black]] — what warm darks replace
- [[Pigments/Particle Size-Tinting-Polymorphism|Particle Size-Tinting-Polymorphism]] — granulation
