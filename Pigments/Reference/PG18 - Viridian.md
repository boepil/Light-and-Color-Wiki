...
sequence: 58
---
<div style="float:left;width:64px;height:64px;background:#2E8B57;margin:4px 16px 8px 0;border-radius:2px;"></div>
...
**Scope:** Viridian (PG18) — hydrated chromium(III) oxide, Guignet's emerald, the stable cool green that replaced verdigris.
...
Viridian is MacEvoy's standard transparency-green in the classical palette — he recommends it over the heavier chroma of phthalo when naturalistic greens and glazing are the goal, pairing it with cadmium yellow pale and yellow ochre for foliage, and using it thin (glazed) since its masstone goes blackish. His charts class it transparent with moderate staining *(Source: [[raw_sources/handprint/pigmt3.md|pigmt3.html]], [[raw_sources/handprint/palette1.md|palette1.html]])*.

## Subtopics
- Cr₂O₃·2H₂O; cool emerald, bluish undertone
- Pannetier/Binet 1838 → Guignet 1859 → England 1862
- Guignet process; hydration route
- Lightfast, slow oil drier, moderate staining; masstone blackish
- Replaced verdigris/green earth; cadmium-yellow mixes

## Cross-References
- [[Pigments/index|Pigments]] — the section hub
- [[Pigments/Reference/PG7 - Phthalo Green|PG7 - Phthalo Green]] — the high-chroma successor
- [[Pigments/Reference/PY35 - Cadmium Yellow|PY35 - Cadmium Yellow]] — foliage mix partner
- [[Pigments/Reference/PR108 - Cadmium Red|PR108 - Cadmium Red]] — the black-mix partner
