...
MacEvoy builds his modern palette on these organics — PB15, PG7, PR122, PV19 among the backbone hues — precisely because they "push the boundaries of the reproducible gamut," achieving saturation "impossible with natural pigments." His caution is the painter's version of the tinctorial-power warning: "their high tinting strength can easily overwhelm a mixture," so they must be "managed carefully" — learned individually by measured behavior rather than by color-wheel doctrine. MacEvoy also stresses these are not "natural" pigments, and their transparent staining behavior (vs. earthy granulation) changes mixture logic entirely *(Source: [[raw_sources/handprint/pigmt1.md|pigmt1.html]], [[raw_sources/handprint/pigmt3.md|pigmt3.html]])*.

## Subtopics
- PB15 copper phthalocyanine; PG7 (Cl) / PG36 (Cl+Br) greens
- PR122 magenta, PV19 rose/violet; PV23 carbazole violet
- Narrow-band reflectance → chroma independent of value
- The cyan-sector (modern subtractive primary) and red-violet-sector gains
